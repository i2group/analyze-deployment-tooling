...
REDHAT_UBI_IMAGE_NAME="registry.access.redhat.com/ubi8/ubi-minimal"
PROMETHEUS_IMAGE_NAME="i2group/i2eng-prometheus"
GRAFANA_IMAGE_NAME="grafana/grafana-oss"
JAVA_IMAGE_NAME="adoptopenjdk/openjdk11"

###############################################################################
# Image versions                                                              #
###############################################################################
HA_PROXY_IMAGE_VERSION="2.2"
REDHAT_UBI_IMAGE_VERSION="8.6"
SQL_SERVER_IMAGE_VERSION="2019-CU11-rhel-8.3"
JAVA_IMAGE_VERSION="ubi-jre"
